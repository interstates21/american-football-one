...
// Array:
// const someArray = ['hello', 'hi'];
// console.log(someArray[0]) --> displays hello
...
// console.log(greetingObject.evening) --> displays 'Good Evening!'
// console.log(greetingObject['morning']) --> displays 'Good Morning!'
...
//                 fill="#666" fill-opacity="1"></path>
//         </g>
//     </svg>
// </div>
// <p class="material-label">Wood(4)</p>
// </div>